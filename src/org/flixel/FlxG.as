package org.flixel
{
	...
	public class FlxG
	{
		 ...
		 * @author Carter
		 */
		static public var prevState:Class;
		/**
		...
		/**
		 * A container sprite I'm using to put flash images into the game.
		 * @author CC
		 */
		static public var flashObjects:Sprite = new Sprite();
		...
		{
			prevState = FlxU.getClass(FlxU.getClassName(_game._state,false))
		 ...
		 * @param	Force		Force the effect to reset.
		 */
		static public function fade(Color:uint=0xff000000, Duration:Number=1, OnComplete:Function=null, Reset:Boolean=false, Force:Boolean=false):void
		{
			var i:uint = 0;
			var l:uint = FlxG.cameras.length;
			while(i < l)
				(FlxG.cameras[i++] as FlxCamera).fade(Color,Duration,OnComplete,Reset,Force);
		}
