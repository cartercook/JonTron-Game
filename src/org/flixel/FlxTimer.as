package org.flixel
{
	 ...
	 * @author Adam Atomic
	 * 
	 * I edited everything to do with the timerManager here.
	 * @author CC
	 */
	public class FlxTimer
	{
		...
		/**
		 * if null, flixel uses the TimerManager plugin (runs without super.update)
		 */
		protected var _localManager:TimerManager;
		/**
		 ...
		 */
		public function start(Time:Number=1,Loops:uint=1,Callback:Function=null,Manager:TimerManager=null):FlxTimer
		{
			var timerManager:TimerManager;
			if (Manager == null)
				timerManager = manager;
			else
				timerManager = _localManager = Manager;
