...
package org.flixelPP 
{
	...
	public class FlxSpritePP extends FlxSprite
	{
		...
		public function overlapsPP(obj:FlxSpritePP):Rectangle
		{
			...
			// draw red
			bmp.draw(framePixels, _mtxPP, new ColorTransform(1, 1, 1, 1, 255, -255, -255, 255));
			
			// draw green
			if(obj !== this)
				obj._mtxPP.translate( -bounds.x, -bounds.y);
			bmp.draw(obj.framePixels, obj._mtxPP, new ColorTransform(1, 1, 1, 1, -255, 255, -255, 255), BlendMode.ADD);
...
//private
		private function preparePP():void
		{
			...
			_mtxPP.concat(new flash.geom.Matrix(1, skew.y, skew.x, 1, 0, 0));
